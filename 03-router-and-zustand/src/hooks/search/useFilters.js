...
export const useFilters = () => {
    ...
    const [filters, setToFilters] = useState(getInitialFilters(searchParams)) // Podemos extraer la lógica de la inicialización de los filtros en una función para que no se vea tan cargado el hook y que sea más fácil de leer
